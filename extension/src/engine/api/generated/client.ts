...
export const dataClasses = <TData = AxiosResponse<DataClassBean[]>>(
...
export const importProcess = <TData = AxiosResponse<unknown>>(
...
export const projects = <TData = AxiosResponse<ProjectBean[]>>(
...
export const refreshProjectStatuses = <TData = AxiosResponse<ProjectBean[]>>(
     options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
...
export const createPmvAndProjectFiles = <TData = AxiosResponse<ProjectBean>>(
...
export const invalidateClassLoader = <TData = AxiosResponse<unknown>>(
 ...
 */
export const me1 = <TData = AxiosResponse<UserBean>>(
     options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
      `/web-ide/me`,options
 ...
 */
export const logoutMe = <TData = AxiosResponse<unknown>>(
     options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.post(
...
export const exportWorkspace = <TData = AxiosResponse<unknown>>(
