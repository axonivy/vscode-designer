...
export const projects = <TData = AxiosResponse<ProjectBean[]>>(params?: ProjectsParams, options?: AxiosRequestConfig): Promise<TData> => {
 ...
 */
export const me1 = <TData = AxiosResponse<UserBean>>(options?: AxiosRequestConfig): Promise<TData> => {
 ...
 */
export const logoutMe = <TData = AxiosResponse<unknown>>(options?: AxiosRequestConfig): Promise<TData> => {
