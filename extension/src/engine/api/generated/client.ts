...
export const readConfig = (params?: ReadConfigParams, options?: AxiosRequestConfig): Promise<AxiosResponse<ConfigurationBean>> => {
...
export const deleteForm = (formIdentifier: FormIdentifier, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const importProcess = (importProcessBody: ImportProcessBody, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const deleteProcess = (processIdentifier: ProcessIdentifier, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
  return axios.delete(`/web-ide/process`, { data: processIdentifier, ...options });
};

export const buildProjects = (buildProjectsBody: string[], options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
  return axios.post(`/web-ide/projects/build`, buildProjectsBody, options);
};

export const deployProjects = (deployProjectsBody: string[], options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const convertProject = (params?: ConvertProjectParams, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const findOrCreatePmv = (projectParams: ProjectParams, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
  return axios.post(`/web-ide/project`, projectParams, options);
};

export const deleteProject = (params?: DeleteProjectParams, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const invalidateClassLoader = (params?: InvalidateClassLoaderParams, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const stopBpmEngine = (params?: StopBpmEngineParams, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
 ...
 */
export const logoutMe = (options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
...
export const deleteWorkspace = (id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Blob>> => {
