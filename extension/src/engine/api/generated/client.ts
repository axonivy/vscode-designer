...
export const getCaseMaps = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<CaseMapBean[]>> => {
    return axios.get(
      `/web-ide/casemaps`,options
    );
  }
...
export const deleteCaseMap = (
    caseMapIdentifier: CaseMapIdentifier, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<unknown>> => {
    return axios.delete(
      `/web-ide/casemap`,{data:
      caseMapIdentifier, ...options}
    );
  }
