...
class UserEditorWebSocketForwarder extends EditorWebSocketForwarder {
  constructor(websocketUrl: URL, messenger: Messenger, messageParticipant: MessageParticipant, document: TextDocument) {
    super(websocketUrl, 'ivy-user-lsp', messenger, messageParticipant, UserWebSocketMessage, document);
  }
