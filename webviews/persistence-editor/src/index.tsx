import { App, ClientContextProvider, PersistenceClientJsonRpc, QueryProvider, initQueryClient } from '@axonivy/persistence-editor';
import '@axonivy/persistence-editor/lib/editor.css';
...
export async function start({ file }: InitializeConnection) {
  const connection = toConnection(messenger, 'persistenceWebSocketMessage');
